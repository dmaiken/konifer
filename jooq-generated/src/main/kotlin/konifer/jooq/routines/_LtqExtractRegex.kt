...
open class _LtqExtractRegex : AbstractRoutine<Ltree>("_ltq_extract_regex", Public.PUBLIC, DSL.comment(""), DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), LtreeBinding()) {
    companion object {
        ...
        val _2: Parameter<Any?> = Internal.createParameter("_2", DefaultDataType.getDefaultDataType("\"public\".\"lquery\""), true)
    }
    ...
    fun set__1(value: Array<org.jooq.postgres.extensions.types.Ltree?>?): Unit {
        setValue(_LtqExtractRegex._1, value)
    }
    ...
    fun set__2(value: Any?): Unit {
        setValue(_LtqExtractRegex._2, value)
    }
