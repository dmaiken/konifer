...
val ASSET_LABEL__FK_ASSET_LABEL_ASSET_ID_ASSET_TREE_ID: ForeignKey<AssetLabelRecord, AssetTreeRecord> = Internal.createForeignKey(AssetLabel.ASSET_LABEL, DSL.name("fk_asset_label_asset_id_asset_tree_id"), arrayOf(AssetLabel.ASSET_LABEL.ASSET_ID), konifer.jooq.keys.ASSET_TREE_PKEY, arrayOf(AssetTree.ASSET_TREE.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val ASSET_TAG__FK_ASSET_TAG_ASSET_ID_ASSET_TREE_ID: ForeignKey<AssetTagRecord, AssetTreeRecord> = Internal.createForeignKey(AssetTag.ASSET_TAG, DSL.name("fk_asset_tag_asset_id_asset_tree_id"), arrayOf(AssetTag.ASSET_TAG.ASSET_ID), konifer.jooq.keys.ASSET_TREE_PKEY, arrayOf(AssetTree.ASSET_TREE.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val ASSET_VARIANT__FK_ASSET_VARIANT_ASSET_ID_ASSET_TREE_ID: ForeignKey<AssetVariantRecord, AssetTreeRecord> = Internal.createForeignKey(AssetVariant.ASSET_VARIANT, DSL.name("fk_asset_variant_asset_id_asset_tree_id"), arrayOf(AssetVariant.ASSET_VARIANT.ASSET_ID), konifer.jooq.keys.ASSET_TREE_PKEY, arrayOf(AssetTree.ASSET_TREE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
