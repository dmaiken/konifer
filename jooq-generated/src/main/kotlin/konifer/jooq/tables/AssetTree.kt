...
open class AssetTree(
     ...
     */
    override fun where(condition: Condition?): AssetTree = AssetTree(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): AssetTree = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): AssetTree = where(DSL.notExists(select))
}
