...
val ASSET_VARIANT__FK_ASSET_VARIANT_ASSET_ID_ASSET_TREE_ID: ForeignKey<AssetVariantRecord, AssetTreeRecord> = Internal.createForeignKey(AssetVariant.ASSET_VARIANT, DSL.name("fk_asset_variant_asset_id_asset_tree_id"), arrayOf(AssetVariant.ASSET_VARIANT.ASSET_ID), direkt.jooq.keys.ASSET_TREE_PKEY, arrayOf(AssetTree.ASSET_TREE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
