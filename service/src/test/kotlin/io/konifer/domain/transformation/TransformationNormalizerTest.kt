...
class TransformationNormalizerTest : BaseUnitTest() {
    companion object {
        ...
        fun stripMetadataSource() =
            listOf(
                Arguments.arguments("exif", setOf(MetadataType.EXIF)),
                Arguments.arguments("xmp", setOf(MetadataType.XMP)),
                Arguments.arguments("iptc", setOf(MetadataType.IPTC)),
                Arguments.arguments("exif,xmp", setOf(MetadataType.EXIF, MetadataType.XMP)),
                Arguments.arguments("exif,xmp,iptc", setOf(MetadataType.EXIF, MetadataType.XMP, MetadataType.IPTC)),
                Arguments.arguments(
                    " exif , xmp , iptc ",
                    setOf(MetadataType.EXIF, MetadataType.XMP, MetadataType.IPTC),
                ),
                Arguments.arguments(
                    " eXiF , xMp , iPtC ",
                    setOf(MetadataType.EXIF, MetadataType.XMP, MetadataType.IPTC),
                ...
                Arguments.arguments("exif,,,xmp,iptc", setOf(MetadataType.EXIF, MetadataType.XMP, MetadataType.IPTC)),
                Arguments.arguments("", emptySet<MetadataType>()),
                Arguments.arguments(" ", emptySet<MetadataType>()),
                Arguments.arguments(" ,, ", emptySet<MetadataType>()),
                Arguments.arguments(null, emptySet<MetadataType>()),
            )

        @JvmStatic
        fun colorSpaceSource() =
            listOf(
                Arguments.arguments(TransformableColorSpace.ORIGIN, ColorSpace.SRGB),
                Arguments.arguments(TransformableColorSpace.SRGB, ColorSpace.SRGB),
                Arguments.arguments(TransformableColorSpace.P3, ColorSpace.P3),
            )
    }
    ...
    inner class NormalizeRotateFlipTests {
        @ParameterizedTest
        @MethodSource("io.konifer.domain.transformation.TransformationNormalizerTest#rotateFlipSource")
    ...
    inner class NormalizeMetadataTests {
        @ParameterizedTest
        @MethodSource("io.konifer.domain.transformation.TransformationNormalizerTest#stripMetadataSource")
    ...
    inner class NormalizeColorSpaceTests {
        @ParameterizedTest
        @MethodSource("io.konifer.domain.transformation.TransformationNormalizerTest#colorSpaceSource")
        fun `normalizes strip metadata when supplied`(
