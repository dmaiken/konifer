...
class RequestContextFactoryTest : BaseUnitTest() {
    ...
    inner class GetRequestContextTests {
        ...
        @ParameterizedTest
        @MethodSource("io.asset.context.RequestContextFactoryTest#transformationSource")
    ...
    inner class DeleteRequestContextTests {
        @ParameterizedTest
        @MethodSource("io.asset.context.RequestContextFactoryTest#deleteModifierSource")
